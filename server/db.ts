...
if (isProduction) {
  ...
  preferences = pgTable("preferences", {
    ...
    bannerHeight: pgInteger("banner_height").notNull().default(72),
    fontSize: pgInteger("font_size").notNull().default(60),
  ...
  preferences = sqliteTable("preferences", {
    ...
    bannerHeight: sqliteInteger("banner_height").notNull().default(72),
    fontSize: sqliteInteger("font_size").notNull().default(60),
    ...
    try {
      await pool.query(`
        ...
        CREATE TABLE IF NOT EXISTS preferences (
          ...
          banner_height INTEGER NOT NULL DEFAULT 72,
